...
public class RelatorioReservas {
    ...
    public void incrementarAlunos(int qtdAlunosManha, int qtdAlunosTarde, int qtdAlunosNoite) {
    	qtdAlunosManha += this.quantidadeAlunosManha;
    	qtdAlunosTarde += this.quantidadeAlunosTarde;
    	qtdAlunosNoite += this.quantidadeAlunosNoite;
    }
}
